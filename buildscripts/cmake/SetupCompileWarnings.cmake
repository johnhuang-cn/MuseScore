...
if (MSVC)
    ...
    add_compile_definitions(_SILENCE_EXPERIMENTAL_COROUTINE_DEPRECATION_WARNINGS) # needed for VS 2025 (17.13+) to suppress STL1011
...
function(target_no_warning TARGET WNAME)
    ...
    elseif(WNAME STREQUAL "-Wno-unused-result")
        set(MSVC_Warning )
    elseif(WNAME STREQUAL "-Wno-aggressive-loop-optimizations")
        set(MSVC_Warning )
        set(GCC_Warning $<$<COMPILE_LANGUAGE:C>:-Wno-aggressive-loop-optimizations>)
        unset(CLANG_Warning)
