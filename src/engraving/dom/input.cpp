...
StaffGroup InputState::staffGroup() const
{
    ...
    // if not tab or jianpu, pitched/unpitched input depends on instrument, not staff (override StaffGroup)
    if (staffGroup != StaffGroup::TAB && staffGroup != StaffGroup::JIANPU) {
