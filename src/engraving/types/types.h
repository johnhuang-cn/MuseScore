...
enum class StaffGroup : unsigned char {
    STANDARD, PERCUSSION, TAB, JIANPU
};
constexpr int STAFF_GROUP_MAX = int(StaffGroup::JIANPU) + 1; // out of enum to avoid compiler complains about not handled switch cases
